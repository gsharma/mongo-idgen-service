...
public class UUIDGen {
    ...
    // placement of this singleton is important. It needs to be instantiated
    // *AFTER* the other statics.
    ...
    /**
     * Creates a type 1 UUID (time-based UUID) that substitutes a hash of an IP
     * address in place of the MAC (unavailable to Java).
     * 
     * @param addr
     ...
     * representation of a type 1 UUID (a time-based UUID).
     * 
     * <p>
     * <i><b>Warning:</b> This method is not guaranteed to return unique UUIDs;
     * Multiple invocations using identical timestamps will result in identical
     * UUIDs.</i>
     * </p>
     * 
     * @param timeMillis
